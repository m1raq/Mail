package ru.miraq.mail.authservice.service;
...
import ru.miraq.mail.authservice.repository.RefreshTokenRepository;
...
public class RefreshTokenService {
    ...
    @Value("${service.security.jwtRefreshExpirationMs}")
